...
const PROJECTS = [
  ...
  },
  {
    code: "02",
    name: "PULSE",
    desc: "Analytics dashboard turning raw event streams into live, drillable charts for product teams — built for speed at scale.",
    tags: ["Next.js", "TypeScript", "D3.js", "GraphQL"],
    glow: "violet",
  },
  {
    code: "03",
    name: "ORBIT",
    desc: "E-commerce storefront with an interactive 3D product viewer, letting shoppers rotate and inspect items before buying.",
  ...
  },
  {
    code: "04",
    name: "CIPHER",
    desc: "End-to-end encrypted messaging app with peer-to-peer video, built for privacy-first teams.",
    tags: ["React Native", "WebRTC", "Node.js", "Redis"],
    glow: "cyan",
  },
];
